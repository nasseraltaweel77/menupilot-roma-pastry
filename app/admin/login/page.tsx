  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-paper px-4">
      <section className="panel w-full max-w-md p-6">
        <div className="mb-6">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-clay">Roma Pastry</p>
          <h1 className="mt-2 text-2xl font-bold text-ink">Admin login</h1>
          <p className="mt-2 text-sm text-stone-500">Sign in to manage the Roma Pastry menu and orders.</p>
        </div>
        {params.error ? (
